...
saveRDS(m_vpd_median, here("analysis", "models","m_vpd_ma_median.rds"))
saveRDS(m_cmi_median, here("analysis", "models","m_cmi_ma_median.rds"))
saveRDS(m_vpd_ext, here("analysis", "models","m_vpd_ma_ext.rds"))
saveRDS(m_cmi_ext, here("analysis", "models","m_cmi_ma_ext.rds"))
```
...
```{r}
estimates_cmi <- get_lag_estimates(m_cmi_median, lag_var = "LL", smooth_var = "cmi_wy", weights = "weights_btl2")
